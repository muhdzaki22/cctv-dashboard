<x-guest-layout>
    <h2 class="text-xl font-bold text-gray-800 text-center mb-6">Create Account</h2>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password" type="password" name="password" required autocomplete="new-password" placeholder="At least 8 characters" />
